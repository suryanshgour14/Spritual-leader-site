...
export default function FooterClientLinks() {
  return (
    <ul className="flex flex-col gap-3">
      ...
      <li className="flex items-center gap-3 mt-2">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => analytics.socialLinkClicked('youtube')}
          className="p-2 text-cream-300 hover:text-red-400 transition-colors rounded-lg hover:bg-white/5"
          aria-label="YouTube"
        >
        ...
        <a
          href="https://www.facebook.com/SadhviSamahitaDidi"
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => analytics.socialLinkClicked('facebook')}
          className="p-2 text-cream-300 hover:text-blue-400 transition-colors rounded-lg hover:bg-white/5"
          aria-label="Facebook"
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
        ...
        <a
          href="https://www.instagram.com/sadhvisamahita/"
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => analytics.socialLinkClicked('instagram')}
          className="p-2 text-cream-300 hover:text-pink-400 transition-colors rounded-lg hover:bg-white/5"
